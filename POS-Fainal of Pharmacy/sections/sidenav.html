...
<div class="sidenav">
  <div class="card">
    <div class="card-body">
      <div class="logo">
        <img src="images/logopic.png" class="profile"/> 
        <h1 class="logo-caption"><span class="tweak">By</span> <br> Tetra-Link </h1>
      </div> <!-- logo class -->
      ...
      <div id="third" class="main-menu-item" onclick="showhide(this.id);">
      	...
      	<ul class="treeview-menu" style="display: none;">
      		<li class="treeview"><a href="add_medicine.php">Add Product</a></li>
      		<li class="treeview"><a href="manage_medicine.php">Manage Product</a></li>
          <li class="treeview"><a href="manage_medicine_stock.php">Manage Product Stock</a></li>
      	</ul>
      </div>
      <!-- medicine end -->
      ...
      <div id="seventh" class="main-menu-item" onclick="showhide(this.id);">
          ...
          <li class="treeview"><a href="manage_customer.php">Customer</a></li>
      		<li class="treeview"><a href="manage_medicine.php">Product</a></li>
